...
- `2026-08-30-spec27-key-reconciliation.md` — ✅ ready（SDD #27，读方↔写方键空间对账，7 tasks）

（前一项 SDD #26 plan 已交付归档，见 `archive/2026-08-30-snapshot-wiring-removal.md`，PR #105）
