> **Date:** 2026-08-16 | **Revised:** 2026-08-31（v2：价值门删 F376/F604；v3：阶段 3 设计审查 1C/3I/5M 修订；v4：route_block 权威冲突裁决等二轮修订；v5：anti-ai 活面重定向等三轮修订；v6：校准覆盖落点单元格 patch 等四轮修订；v7：五轮审查 0C/3I/3M 修订——cell-patch 明示为 truth_io 新原语（列定位语义）、校准/锚点记录改 keyed truth 行（避开 decisions schema 封闭枚举）、修订上限迁入 revision_router）| **Status:** Design (Revised 2026-08-31) | **Severity:** 🟠 P1 | **方法:** systematic-debugging 四阶段
