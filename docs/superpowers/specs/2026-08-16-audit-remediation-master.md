> **Date:** 2026-08-16 | **Status:** Design（索引长期保留 per §5；§8 记账 pass Done — PR #147, 2026-09-03 · §6.4 同步 pass Done — PR <本批>（C27-C35 回标，2026-09-07）） | **Severity:** 🔴 P0（总纲）| **方法:** 聚类→spec 映射与依赖排序
