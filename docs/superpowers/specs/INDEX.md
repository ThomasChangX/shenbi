...
- **系列**：2026-08-15 全项目深度审计 · 阶段 5（簇 C9，原 18 条，修订后 15 条 LIVE；候选元根因 D 分簇二）
- **状态**：Design (Revised 2026-08-31) | **优先级**：🟠 P1
- **内容**：阈值多源矛盾（F134/F411/F760/F846/F818）、契约规则 9 缺 2（F232）、"林烽"硬编码（F443）——thresholds.py 单源 + genre-config 契约补全 + 阈值对账 lint（F202/F436/F603 已由 spec #8/#13 提前修复，2026-08-31 剔除）
