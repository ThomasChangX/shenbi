...
- **状态**：Revised（2026-08-30 收窄 41 条执行中）| **优先级**：⚪ Low（批量）
- **内容**：全仓库 M 级文案/命名/格式/过期注释按区分节批量清理；2026-08-30 价值门收窄：41 条无主残留执行，82 条移交活跃簇 spec（含 F478→#27、F3A1→#27、F351→#47、F270→#46、F653→#32），6 条已修核销（F166/F344/F509/F618/F0-04/F3B3）
