...
> **最后更新**：2026-09-08（#53 C15 Done PR #189——10 面行为级测试 + per-module 覆盖底线表；此前 #40 维护 pass）
> **活跃 spec 数**：13（#53 C15 Done PR #189——10 面行为级测试 + per-module 覆盖底线表；#46 C32 Rejected：11 条成员已由 PR #43 修复；F513 残留待新归属）
