> **Date:** 2026-09-11 | **Status:** Done (PR #229 REWRITE + PR #230 实施 · 2026-09-18) · Revised 2026-09-18（SDD #66 价值门 REWRITE——素材源出库重定向 git 历史、truth 载体处方单块化、chapter_summaries frontmatter 裁决、locations 复用既有件；驳斥审查证据见当批 progress）| **Severity:** 🟡 P2（两 finding 均 P2 · 微修 S 量级）| **方法:** 机械替换 + 配置统一（无需 systematic-debugging——两 finding 根因与修复路径均已定案）
