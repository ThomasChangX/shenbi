> **Date:** 2026-08-14 | **Status:** Rejected (2026-08-30 · 与活跃 spec #30 簇级合并版重复——#30（audit-decisions-chain，🟥 Critical）文首显式声明吸收本 spec 未完成面，其 T2/T4+T5/T3/T106/T5+T7 逐一覆盖本 spec R1/R2/R3/T1-04·T1-05/T1-07 且为严格超集（新增 T101 P0 路由绕过、T104 容错对撞）。残余未认领子项：T1-06 SkillOutput.decisions 死字段——归 #30 执行时核对或在 #30 归档时另立 spec) | **Severity:** 🟠 P1 | **方法:** systematic-debugging 四阶段
