...
- **验收**：`just audit-lint`（无参全目录模式——F969/F972/F973 缺口在 2026-08-14 run、F975/F1176 在 2026-08-15 run，须两轮都被扫）——F969/F972/F973 被机械抓出且以豁免注记闭合（豁免清单由 dry-run 真实命中生成）；F975（漏登=省略抓不到）与 F1176（08-15 报告内矛盾已被本批回填修正）以执行期核实注记闭合（记 deviation）；row_columns 检查容忍既有回写注记列（第 12+ 列匹配注记语法）；`just check` 含该 lint 且全绿
