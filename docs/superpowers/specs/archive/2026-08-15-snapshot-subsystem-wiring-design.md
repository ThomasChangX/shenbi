> **Date:** 2026-08-15 | **Status:** Done (PR #105 · 路径 3 移除 · 2026-08-30)（裁决依据见 docs/superpowers/plans/archive/2026-08-30-snapshot-wiring-removal.md：恢复消费者已被产品决策移除 + checkpoint-redo/skill-rollback/crash 三重覆盖 + prune 无界增长 + 双写冲突） | **Severity:** 🟠 P1 | **方法:** systematic-debugging 四阶段
