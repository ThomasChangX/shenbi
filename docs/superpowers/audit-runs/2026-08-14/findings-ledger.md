...
| F397 | state-settling 的 append_dedup/upsert 写语义在派发写路径是 no-op：累积 truth 文件（chapter_summaries/emotional_arcs/particle_ledger/subplot_board）每章被整文件覆写为仅当章内容，前章数据确定性丢失 | error | P1 | 见 Z3.review12.md#F397 | 见报告 | 见报告 | 见报告 | 见报告 | deep-read | verified |
