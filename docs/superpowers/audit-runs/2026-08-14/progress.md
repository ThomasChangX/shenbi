...
| 2 分区深度审查 | in_progress | 轮次历史：Z1(13→9→5→6→4→…) Z2(20→6→8→3→…) Z3(22→11→10→8→11→7→…) Z4(19→12→9→6→10→…) Z5(12→4→8→6→6→2→…) Z6(11→8→10→7→3→3→1→…)；F325 误报撤销；P0×1(F324)、P1×20+；Z7-Z11 待派发 |
| 3 线程 | pending | — |
| 4 聚类校准 | pending | — |
| 5 spec 产出 | pending | — |
| 6 覆盖证明+裁决 | pending | — |
