...
| 2 分区深度审查 | in_progress | 轮次历史：Z1(13→9→5→6→4→6→1→2→6→2→3→2→2→…) Z2(20→6→8→3→7→1→2→3→2→…) Z3(22→11→10→8→11→7→5→1→3→…) Z4(19→12→9→6→10→6→3→11→3→…) Z5(12→4→8→6→6→2→0✓收敛) Z6(11→8→10→7→3→3→1→3→2→5→2→…)；F325 误报撤销；P0×1(F324)、P1×25+（含 F397 append_dedup 数据丢失贴 P0）；Z7-Z11 待派发 |
| 3 线程 | pending | — |
| 4 聚类校准 | pending | — |
| 5 spec 产出 | pending | — |
| 6 覆盖证明+裁决 | pending | — |
