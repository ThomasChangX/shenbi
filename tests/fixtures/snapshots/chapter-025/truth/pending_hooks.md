...
- id: hook-ch1-001
  content: "催收员告知林烽灵能修炼贷款已逾期，墙上告示列出逾期处罚条款——强制劳役或灵能僭越罪。林烽第一次意识到这个世界'欠债'的含义远比现代严重。日千分之三复利设计使还款成为数学死循环。"
  state: PLANTED
  operation: plant
  type: GENUINE
  dimension: THEMATIC
...
- id: hook-ch1-002
  content: "林烽穿越后感知到空气中存在他人似乎不察的灵能嗡鸣——低频震颤像电流穿过骨骼。章末在破屋独处时，安静环境中这种感知变得更清晰。手掌接触木板时能感知纤维结构。他将其归因为'穿越后遗症'。"
  state: PLANTED
  operation: plant
  type: GENUINE
  dimension: CHARACTER
...
```
第1章 ── hook-ch1-001 (THEMATIC, core) PLANTED
     ├── hook-ch1-002 (CHARACTER) PLANTED
