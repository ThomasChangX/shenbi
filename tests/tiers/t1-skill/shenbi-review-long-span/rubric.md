# T1 Rubric: shenbi-review-long-span
...
| # | Dimension | Weight | Standard |
|---|-----------|--------|----------|
| 8 | N-gram extraction accuracy | 20% | 6-char n-gram repetition rate computed per formula in SKILL.md against last 5 chapters; threshold cross-checked |
