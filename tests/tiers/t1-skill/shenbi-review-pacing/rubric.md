# T1 Rubric: shenbi-review-pacing
...
| # | Dimension | Weight | Standard |
|---|-----------|--------|----------|
| 8 | Chapter type classification accuracy | 20% | QUEST/FIRE/CONSTELLATION assigned per definitions in rhythm_principles.md for last 5 chapters |
