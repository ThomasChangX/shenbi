...
|----------|--------|-------------------|
| `tests/fixtures/audit-report-example.md`: chapter 7 classification | Chapter 7 classified as QUEST when content matches FIRE definition (high-stakes confrontation, rapid dialogue, emotional escalation per rhythm_principles.md) | error |
