# Generative Test: shenbi-review-world-rules
...
1. Numerical cross-reference table (ages, dates, distances, counts)
2. World rule compliance check
3. Character consistency against truth files
