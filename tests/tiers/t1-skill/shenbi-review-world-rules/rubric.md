# T1 Rubric: shenbi-review-world-rules
...
| # | Dimension | Weight | Standard |
|---|-----------|--------|----------|
| 8 | Numerical cross-reference | 20% | Every numerical claim (ages/dates/distances/counts) verified against truth files with file+field reference |
