...
## Test Setup
A novel project exists with drafted chapter 7 at `tests/fixtures/chapter-draft-example.md`. Truth files include all character profiles, world rules, and numerical data. Every numerical claim in the chapter (ages, dates, distances, counts) matches the truth files exactly.
