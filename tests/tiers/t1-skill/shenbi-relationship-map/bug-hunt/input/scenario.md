...
- `tests/fixtures/character-profile-example.md` — relationship matrix with evolution plans
- `tests/fixtures/characters/` — character profiles (already exist)
...
|----------|--------|-------------------|
| `tests/fixtures/character-profile-example.md`: protagonist-antagonist relationship entry | No evolution plan — missing start state, turning points, and expected end state | error |
