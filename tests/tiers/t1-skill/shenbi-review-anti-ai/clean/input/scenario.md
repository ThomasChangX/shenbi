...
## Test Setup
A novel project exists with drafted chapter 6 at `tests/fixtures/chapter-draft-example.md`. The SKILL.md defines a checklist of 10 deterministic anti-AI pattern checks. All 10 checks are executed and all return PASS. No AI-pattern violations detected.
