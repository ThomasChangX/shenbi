...
| # | Dimension | Weight | Standard |
|---|-----------|--------|----------|
| 8 | Anachronism detection | 20% | Every artifact/vocabulary/institution verified against the declared time period; unverified items flagged |
