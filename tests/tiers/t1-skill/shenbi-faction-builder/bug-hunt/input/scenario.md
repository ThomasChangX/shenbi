...
- `world/factions/*.md` — one file per faction
- `world/faction-relations.md` — cross-faction relationship map
...
|----------|--------|-------------------|
| `world/factions/order-of-ash.md`: internal structure section | No internal factional split — faction described as fully unified with zero dissent | error |
