...
|----------|--------|-------------------|
| `tests/fixtures/audit-report-example.md`: character deviation finding | Severity misclassification — character deviation (哈利逃跑) classified as "warning" in Canon mode, but SKILL.md severity table requires "error" for character deviations in Canon mode | error |
