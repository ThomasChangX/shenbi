# T1 Rubric: shenbi-review-fanfic
...
| # | Dimension | Weight | Standard |
|---|-----------|--------|----------|
| 8 | Mode strictness application | 20% | Canon/AU/OOC/CP mode determines severity per SKILL.md severity table; undeclared deviations always error |
