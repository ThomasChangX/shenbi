...
## Test Setup
A novel project exists with drafted chapter 6 at `tests/fixtures/chapter-draft-example.md`. Character truth files are at `tests/fixtures/truth/character_profiles/`. The chapter features 3 characters: protagonist 林墨, 苏晴, and 老陈. All characters' BDI assessments are present and correct. Every speaking/acting character is fully covered.
