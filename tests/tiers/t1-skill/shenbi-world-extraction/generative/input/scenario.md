...
## Test Setup
A fantasy novel manuscript with 18 chapters has been analyzed. Import analysis output exists at `import/analysis/03_world.md`. No world files have been generated yet.

## Agent Task
Run shenbi-world-extraction on the analyzed manuscript. The agent must:
1. Read import/analysis/03_world.md and source chapters for location/faction/power references
...
## Seed Input
Analyzed manuscript at `import/analysis/03_world.md` with source `chapters/*.md` (18 chapters)
