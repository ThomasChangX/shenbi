# T1 Rubric: shenbi-review-sensitivity
...
| # | Dimension | Weight | Standard |
|---|-----------|--------|----------|
| 8 | Platform rule application | 20% | Platform rules from novel.json target_platform applied; every prohibited word from fatigue list checked |
