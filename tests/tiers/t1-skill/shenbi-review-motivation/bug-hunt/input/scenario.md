...
## Test Setup
A novel project exists with drafted chapter 8 at `drafts/chapter-8.md`. Character profiles at `truth/character_profiles/` define character motivations and personality traits. In chapter 8, the protagonist 林墨 suddenly decides to betray his ally 苏晴 by revealing her location to the antagonist. This is a major character action with significant consequences.
...
|----------|--------|-------------------|
| `drafts/chapter-8.md`: paragraph 14-15 | Broken causal chain — 林墨's betrayal of 苏晴 has no trigger or judgment; character acts with no prior motivation event, skipping trigger and judgment links in the causal chain | error |
