...
## Test Setup
A novel project exists with drafted chapter 6 at `drafts/chapter-6.md`. Character profiles at `truth/character_profiles/` define character motivations. Every major action in the chapter has a complete causal chain: trigger → judgment → action → consequence.
