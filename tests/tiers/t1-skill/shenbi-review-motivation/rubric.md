# T1 Rubric: shenbi-review-motivation
...
| # | Dimension | Weight | Standard |
|---|-----------|--------|----------|
| 8 | Causal chain reconstruction | 20% | Every major action has complete chain: trigger → judgment → action → consequence; missing links flagged |
