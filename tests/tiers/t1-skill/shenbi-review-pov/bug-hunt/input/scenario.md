...
## Test Setup
A novel project exists with drafted chapter 9 at `drafts/chapter-9.md`. The chapter is written in third-person limited POV from 林墨's perspective. According to chapter summaries at `truth/chapter_summaries.md`, a critical secret — that 苏晴 is secretly working for the antagonist — was revealed in a private conversation between 苏晴 and the antagonist in chapter 7. 林墨 was not present at this conversation and has no way of knowing this secret.
...
|----------|--------|-------------------|
| `drafts/chapter-9.md`: paragraph 6 | Information leakage — POV character 林墨 knows 苏晴's secret alliance with the antagonist, but was never present at the revelation (ch7 private conversation); no acquisition channel exists | error |
