# Generative Test: shenbi-review-texture
...
1. Sequential marker count per paragraph (然后/接着/之后/随后)
2. Laundry-list detection (paragraphs with ≥3 markers and zero conflict)
3. Prose variety assessment
