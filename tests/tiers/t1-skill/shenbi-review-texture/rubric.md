# T1 Rubric: shenbi-review-texture
...
| # | Dimension | Weight | Standard |
|---|-----------|--------|----------|
| 8 | Laundry-list detection | 20% | Sequential markers (然后/接着/之后/随后) counted per paragraph; paragraphs with ≥3 sequential markers and zero conflict flagged |
