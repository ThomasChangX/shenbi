...
## Test Setup
A 20-chapter short novel has been completed. The short packaging has been correctly run, producing packaging materials (titles, blurbs, selling points, cover prompt, keywords) derived from the completed novel chapters at `tests/fixtures/chapters/`.
