# T1 Rubric: shenbi-review-dialogue
...
| # | Dimension | Weight | Standard |
|---|-----------|--------|----------|
| 8 | Voice fingerprint matching | 20% | Per-speaker: sentence length, vocabulary range, sentence pattern deviation quantified against voice_profile baseline |
