...
- `story/pacing.md` — pacing cycles, scene types, three-line balance
- `story/scene-types.md` — catalog of scene types with detection criteria
...
|----------|--------|-------------------|
| `story/pacing.md`: Cycle 3 (chapters 18-24) | Missing "aftermath" beat — cycle has only buildup, escalation, explosion | error |
