# T1 Rubric: shenbi-review-memo-compliance
...
| # | Dimension | Weight | Standard |
|---|-----------|--------|----------|
| 8 | Section-by-section verification | 20% | All 8 memo sections checked independently; each section gets fulfill/partial/missing verdict |
