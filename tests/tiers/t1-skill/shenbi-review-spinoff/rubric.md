# T1 Rubric: shenbi-review-spinoff
...
| # | Dimension | Weight | Standard |
|---|-----------|--------|----------|
| 8 | Timeline-aware leakage | 20% | Every piece of information in spinoff verified against parent timeline; info revealed in parent chapter N is forbidden in spinoff chapter < N |
