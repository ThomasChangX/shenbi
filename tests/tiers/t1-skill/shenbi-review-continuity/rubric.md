# T1 Rubric: shenbi-review-continuity
...
| # | Dimension | Weight | Standard |
|---|-----------|--------|----------|
| 8 | Timeline extraction precision | 20% | Time markers extracted and cross-compared across ≥2 chapters; every explicit time reference accounted for |
