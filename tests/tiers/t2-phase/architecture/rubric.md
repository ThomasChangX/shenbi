# T2 Phase Rubric: Architecture

Phase: story-architecture → volume-outlining → pacing-design → plot-thread-weaver → genre-config
Seed: Output from Genesis phase
...
| 2 | Cross-skill consistency | 20% | Zero contradictions between outputs of different skills (e.g., pacing-design doesn't violate story-architecture structure) |
...
- outline/architecture.md
- outline/volumes.md
- outline/pacing.md
- outline/plot_threads.md
- genre-config.json
