# T2 Phase Rubric: Import

Phase: import-analysis → character-extraction → world-extraction → canon-import
Seed: tests/fixtures/report-example.txt
...
| 2 | Cross-skill consistency | 20% | Zero contradictions between outputs of different skills (e.g., character-extraction doesn't conflict with world-extraction) |
...
- import/analysis/
- characters/ (extracted character files)
- world/ (extracted world files)
- import/canon/
