...
> **2026-09-21**：验收层已由 spec #68（`docs/superpowers/specs/archive/2026-09-21-poc-e2e-longitudinal-acceptance.md`，Done PR #237）接替——纵向判据 / 失败分类学 / 扩展性观测以该 spec 为准；本文件的 T1/T2/T3 执行协议与三不原则继续有效。
